...
const Footer = () => {
    return (
        <section className="py-10 bg-gray-100 pt-16  sm:pt-24 relative">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <img className="w-auto h-9" src={`${logo.src}`} alt="Go Global Logo" />

                        <p className="text-base leading-relaxed text-gray-600 mt-7">Go Global is a trusted study abroad consultancy offering expert advice and personalized solutions for students aspiring to study internationally.</p>
                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-4">
                            <li>
                                <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Blog </a>
                            </li>
                            ...
                            <li>
                                <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Help </a>
                            </li>
                        </ul>
                    </div>
